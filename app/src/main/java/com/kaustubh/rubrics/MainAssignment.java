...
public class MainAssignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buto = (Button) findViewById(R.id.addac);
        ...
        Button but = (Button) findViewById(R.id.viewac);
        but.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Pass the context and the Activity class you need to open from the Fragment Class, to the Intent
                Intent intent = new Intent(getApplicationContext(),View_Assignment.class);
                startActivity(intent);
            }
        });
    }
