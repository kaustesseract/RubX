...
public class MainClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bt = (Button) findViewById(R.id.addc);
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent y = new Intent(getApplicationContext(), AddStudentclass.class);
                startActivity(y);
        ...
        Button bto = (Button) findViewById(R.id.viewc);
        bto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent y = new Intent(getApplicationContext(), Class_list.class);
                startActivity(y);
