...
public class Show_GradeClass extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show__grade_class);
        ...
        ListView ll = (ListView)findViewById(R.id.sgclass);
        ...
        ll.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(getApplicationContext(), Show_GradeCourse.class);
