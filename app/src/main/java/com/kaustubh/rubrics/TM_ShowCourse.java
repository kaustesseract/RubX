...
public class TM_ShowCourse extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tm__show_course);
        ...
        ListView ll = (ListView)findViewById(R.id.tmcourse);
        ...
        ll.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(getApplicationContext(), TMSelect_Assignment.class);
