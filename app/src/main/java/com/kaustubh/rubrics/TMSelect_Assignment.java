...
public class TMSelect_Assignment extends AppCompatActivity {

    DatabaseHelper db = new DatabaseHelper(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tmselect__assignment);
        ...
        final String table = "Course"+"_"+course+"_"+coid;
        db.open();
        ...
        ListView ll = (ListView)findViewById(R.id.tmassignment);
